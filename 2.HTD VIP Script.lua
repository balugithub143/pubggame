gg.toast("High-Tech Dost \n Pubg Hack Simple Script")

gg.setVisible(false)
HOME = 1
function HOME()
  MN = gg.choice({
  "馃彙 岽♂磤薀薀 蕼岽�岽勧磱 & 岽勧磸薀岽忈礈蕗",
  "馃浉 岽嶀磭纱岽� 蕼岽�岽勧磱s",
  "馃寶 岽犐湵岽溼磤薀 蕼岽�岽勧磱隃� ",  
  "馃攣 Log clear ",    
  "銆愥磭x瑟岽涖��",
}, nil, (os.date("VIP Script By High-Tech Dost\nToday's Date: %Y/%m/%d \t Time: %H:%M:%S")))
if MN == nil then
else
if MN == 1 then WC()end
if MN == 2 then MH()end
...
function WC()
  MN1 = gg.multiChoice({
  "馃彙 岽♂磤薀薀 蕼岽�岽勧磱 845",
  "馃帹 蕪岽囀熓熱磸岽� 岽勧磸薀岽忈礈蕗 845",
  "馃帹 蕶薀岽溼磭 岽勧磸薀岽忈礈蕗 845",
  "馃帹 蕗岽囜磪 岽勧磸薀岽忈礈蕗 845",
  "馃帹  岽∈溕礇岽�  岽勧磸薀岽忈礈蕗 845  " ,
   "馃彙 岽♂磤薀薀 蕼岽�岽勧磱 636",
   "馃帹 蕪岽囀熓熱磸岽� 岽勧磸薀岽忈礈蕗 636",
   "馃巿Red colour 636",
      " 馃彌锔�  wall 450",
      "鈾ｏ笍colour 450 ",
      "馃寠Wallhack 625",
...
if MN1[1] == true then WH845()end
if MN1[2] == true then YL845()end
if MN1[3] == true then BL845()end
if MN1[4] == true then RED845()end
if MN1[5] == true then wi845()end
if MN1[6] == true then WH636()end
if MN1[7] == true then YL636()end
if MN1[8] == true then rg636()end
if MN1[9] == true then WH450()end
if MN1[10] == true then YL450()end
if MN1[11] == true then WH625()end
if MN1[12] == true then CL625()end
if MN1[13] == true then WH835()end
if MN1[14] == true then CL835()end
if MN1[15] == true then WH660()end
if MN1[16] == true then CL660()end
if MN1[17] == true then WH670()end
if MN1[18] == true then CL670()end
if MN1[19] == true then HOME()end
end
...
function MH()
  MN2 = gg.multiChoice({
  	"馃  less 蕗岽囜磩岽徤� 薀岽徥櫴櫴�",
      "馃幆  蕼岽囜磤岽卻蕼岽忈礇s(lobby)",
      "馃敟  Magic bullet ",
      "馃寕  岽�纱岽涐磭纱纱岽�",
      "馃  蕼瑟散蕼 岽娽礈岽嶀礃 纱岽� 岽呩磤岽嶀磤散岽�",
      "鉁�  s岽樶磭岽囜磪 岽嬌瘁磸岽勧磱 ",
      "馃敱Micro speed run ",   
      "馃殌speed UZI ",
      "馃  no recoil   ",
      ...
      "鈾慒lash speed",
      "鈻讹笍Fast paratute on",
      "馃崅Fast paratue off(after land)",
      "鈫笍Aimbot 180掳 ( training)",
      "鉀嶴peed darcia",
      "馃毘Unlimited fuel",
      "銆愂欋磤岽勧磱銆�",
}, nil, "                 屑训训谋蟻 sc褟谋蟻褌 ")
...
if MN2[6] == true then M6()end
if MN2[7] == true then M7()end
if MN2[8] == true then M8()end
if MN2[9] == true then M9()end
if MN2[10] == true then M10()end
if MN2[11] == true then M11()end
if MN2[12] == true then M12()end
if MN2[13] == true then M13()end
if MN2[14] == true then M14()end
if MN2[15] == true then M15()end
if MN2[16] == true then M16()end
if MN2[17] == true then M17()end
if MN2[18] == true then HOME()end
end
PUBGMH = -1
end
...
gg.clearResults()
    gg.setRanges(32)
    gg.setVisible(false)
    gg.searchNumber("90.77570343018F;8.0F:512",16,false,536870912,0,-1)
    gg.setVisible(false)
...
gg.clearResults()
gg.setRanges(32)
gg.searchNumber("20000;750;0.0001;0.1", 16, false, 536870912, 0, -1)
gg.searchNumber("0.1", 16, false, 536870912, 0, -1)
gg.getResults(100)
gg.editAll("0.0005", 16)
gg.toast("Fast Parachute deactivated!")
end
  
function M15()
gg.alert("PICK UP GUN 鈽� SHOOT 鈽� EXIT 馃敋")
...
gg.toast("Super AimLock Body 180掳 activated!")
end
...
function VC()
MN3 = gg.multiChoice({
"馃寖蕶薀岽�岽勧磱 隃贬磱蕪 薀岽徥櫴櫴�  ",
"鉀呩础蕼瑟岽涐磭 隃贬磱蕪 薀岽徥櫴櫴�  ",
"馃巼clear black sky ",
"鈾� Arora sky colour v1",
"鈾扐rora sky colour  v2",
"馃幁wide view",
"馃洡锔弉o grass erangle",
"馃寗no grass shanhok",
" 銆愂欋磤岽勧磱銆�",
...
if MN3[1] == true then V1()end
if MN3[2] == true then V2()end
if MN3[3] == true then V3()end
if MN3[4] == true then V4()end
if MN3[5] == true then V5()end
if MN3[6] == true then V6()end
if MN3[7] == true then V7()end
if MN3[8] == true then V8()end
...
gg.clearResults()
gg.setRanges(gg.REGION_BAD)
gg.searchNumber(" 1,669,496,843;671,236,104;1,669,562,379;1,074,792,717;8,200;539,250,689;671,088,641:61", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
gg.searchNumber("8200", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(1)
gg.editAll("8198", gg.TYPE_DWORD)
gg.clearResults()
gg.toast("100%")
gg.toast("Black sky lobby activated")
end
...
gg.searchNumber("8200", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(1)
gg.editAll("8193", gg.TYPE_DWORD)
gg.clearResults()
gg.toast("100%")
gg.toast("white sky lobby activated")
end 
...
gg.clearResults()
    ...
    gg.clearResults()
    gg.toast(" Clear Log Match Lobby\nAb land Chato Bhosdi Ke. . .  ")
  end
...
function EXIT()
print(" VIP Script By High-Tech Dost ")
gg.skipRestoreState()
gg.setVisible(true)
  os.exit()
end
